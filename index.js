import{S as p,i as o}from"./assets/vendor-DEu1ZBVp.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=s(e);fetch(e.href,r)}})();const y="45854856-78ad068c46767c3f7b48e1998",d="https://pixabay.com/api/";async function h(i){const t=new URL(d);t.searchParams.set("key",y),t.searchParams.set("q",i),t.searchParams.set("image_type","photo"),t.searchParams.set("orientation","horizontal"),t.searchParams.set("safesearch","true");try{const s=await fetch(t);if(!s.ok)throw new Error("Network response was not ok");const a=await s.json();if(!a.hits||a.hits.length===0)throw new Error("No images found");return a}catch(s){throw console.error("Fetching error:",s),s}}const n=document.querySelector(".gallery-list"),f=i=>{if(!n)return;const t=i.map(({webformatURL:s,largeImageURL:a,tags:e,likes:r,views:l,comments:m,downloads:u})=>`<li class="gallery-item">
      ...
      </li>`).join("");n.innerHTML="",n.insertAdjacentHTML("beforeend",t)},g=document.querySelector(".form"),L=document.querySelector(".gallery-list"),c=document.querySelector(".loader"),w=new p(".gallery-list a",{captionsData:"alt",captionDelay:250,overlayOpacity:.8}),P=async i=>{i.preventDefault(),c.classList.remove("hidden"),L.innerHTML="";const t=i.target.elements.inputField.value.toLowerCase().trim();if(!t){o.error({title:"Error",message:"You need to type something in the field!",position:"topRight"}),c.classList.add("hidden");return}try{const s=await h(t);s.hits.length===0?o.error({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight"}):(f(s.hits),w.refresh())}catch(s){o.error({message:`There was an error: ${s.message}. Please try again!`,position:"topRight"})}finally{c.classList.add("hidden")}g.reset()};g.addEventListener("submit",P);
